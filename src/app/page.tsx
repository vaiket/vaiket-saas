    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900">Vaiket AI</span>
              </div>
            </div>
            ...
            <div className="hidden md:block">
              <div className="ml-4 flex items-center md:ml-6 space-x-4">
                {user ? (
                  <Link href="/dashboard" className="bg-blue-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors">
                    Go to Dashboard
                  </Link>
                ) : (
                  <>
                    ...
                    <Link href="/signup" className="bg-blue-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors">
                      Get Started Free
                    </Link>
                  </>
                )}
          ...
          <div className="md:hidden bg-white border-t border-gray-200">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <div className="pt-4 pb-3 border-t border-gray-200">
                {user ? (
                  <Link href="/dashboard" className="bg-blue-600 text-white block text-center px-3 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors">
                    Go to Dashboard
                  </Link>
                ) : (
                  <>
                    <Link href="/login" className="text-gray-700 hover:text-blue-600 block px-3 py-2 text-base font-medium">Sign In</Link>
                    <Link href="/signup" className="bg-blue-600 text-white block text-center px-3 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors mt-2">
                      Get Started Free
                    </Link>
                  </>
                )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                AI-Powered Email
                <span className="text-transparent bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text"> Automation </span>
                That Works 24/7
              </h1>

              <p className="text-xl text-gray-600 mb-8 max-w-2xl">
                Transform your email communication with intelligent AI that learns your style, 
                responds instantly, and never misses a customer. Focus on what matters while we handle the rest.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                <Link 
                  href={user ? "/dashboard" : "/signup"}
                  className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-200 shadow-lg shadow-blue-500/25 hover:shadow-xl hover:scale-105"
                >
                ...
                <a 
                  href="#how-it-works" 
                  className="inline-flex items-center justify-center gap-2 bg-white border border-gray-300 hover:border-gray-400 text-gray-700 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-200 hover:scale-105"
                >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Why Businesses Choose Vaiket
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Powerful features designed to streamline your communication and boost productivity
            </p>
          </div>
      ...
      <section id="how-it-works" className="py-20 bg-gray-50 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              How Vaiket Transforms Your Email
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get started in minutes and watch your productivity soar
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Connect Your Email</h3>
              <p className="text-gray-600">
                Securely connect your Gmail, Outlook, or any IMAP/SMTP email account in under 2 minutes.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Train Your AI</h3>
              <p className="text-gray-600">
                Our AI learns your communication style and business context to provide personalized responses.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Automate & Scale</h3>
              <p className="text-gray-600">
                Watch as Vaiket handles routine emails while you focus on high-value conversations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="testimonials" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See what our customers say about transforming their email communication
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of businesses saving hours every week with AI-powered email automation
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href={user ? "/dashboard" : "/signup"}
              className="inline-flex items-center justify-center gap-2 bg-white text-blue-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-50 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105"
            >
              <RocketLaunchIcon className="w-5 h-5" />
              Start Free Trial
            </Link>
            <Link 
              href="/pricing"
              className="inline-flex items-center justify-center gap-2 bg-transparent border border-white text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/10 transition-all duration-200"
            >
              View Pricing Plans
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-xl font-bold">Vaiket AI</span>
              </div>
