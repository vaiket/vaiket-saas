...
// 🔹 Utility: website → clean domain (display only)
...
export default function EmailActivationPage() {
  ...
  useEffect(() => {
    async function bootstrap() {
      try {
        ...
        if (!bootData.success || !bootData.website || !bootData.tenantId) {
  ...
  const handleActivate = async () => {
    ...
    try {
      ...
      // ✅ Success OR already exists → go to dashboard
